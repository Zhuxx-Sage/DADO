...
class A3C(Base_Agent):
    ...
    def __init__(self, config):
        ...
        self.actor_critic = self.create_NN(input_dim=self.state_size, output_dim=self.action_size*2)
...
class Actor_Critic_Worker(torch.multiprocessing.Process):
    ...
    def pick_action_and_get_critic_values(self, policy, state, epsilon_exploration=None):
        ...
        action_distribution = create_actor_distribution(self.action_types, model_output, self.action_size)
